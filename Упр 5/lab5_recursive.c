...
int main()
{
    char target_hash[] = "$6$salt$i1etou/cjGIhaFRAAe9Ovyu8VW7eoR4C1h8EpVn8PpPcvBVwfsaYgJRGnPhBZyT5Z3JenrlmY/p02tjS7Gl0w/";
    ...
    return EXIT_SUCCESS;
} // gcc lab5_recursive.c -o lab5_recursive -lcrypt
